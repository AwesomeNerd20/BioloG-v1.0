...
public:
	...
	FText TitleText = NSLOCTEXT("AchievementSystem", "AchievementProgressNameDetailsPanel", "Achievement Progress");
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Details")
	...
	/**Must call UpdateDetails() after making filtering changes at runtime*/
